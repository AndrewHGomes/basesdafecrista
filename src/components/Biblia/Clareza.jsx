      ...
      {ativo && (
        <div className="subtopico">
          ...
          <p>
            ...
            (<span onClick={() => abrirModal(versiculos[18])}>Salmos 19:7</span>
            ). E{" "}
            <q>
            ...
            (
            <span onClick={() => abrirModal(versiculos[19])}>
              Salmos 119:130
            </span>
          ...
          <p>
            ...
            <span onClick={() => abrirModal(versiculos[20])}>
              1ªCoríntios 2:14
            </span>
